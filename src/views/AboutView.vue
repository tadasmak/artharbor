      ...
      data() {
          return {
              ...
              aboutUsImageData: [
                ...
                {title: "Empowering the Artist: Tools for Success", description: "We understand the challenges artists face, and that's why Mosaic Harbor goes beyond being a showcase; it's a toolkit for success. Access resources, participate in workshops, and engage with experts to elevate your craft. Our platform empowers artists to not only share their work but to thrive in their artistic endeavors.", imageUrl: "../src/assets/images/about-us/5.jpg"},
            ]
          }
      },
      methods: {
